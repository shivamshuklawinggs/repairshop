...
export interface AccountsCustomerFiltersType {
  search: string;
...
interface CustomerFiltersProps {
  filters: AccountsCustomerFiltersType;
  onFiltersChange: (filters: AccountsCustomerFiltersType) => void;
  onClearFilters: () => void;
}
...
const CustomerFilters: React.FC<CustomerFiltersProps> = ({
  ...
  const updateFilter = (key: keyof AccountsCustomerFiltersType, value: any) => {
    onFiltersChange({
      ...filters,
      [key]: value,
    });
